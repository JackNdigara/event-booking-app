            ...
            <div class="row">
              <div class="col-md-4">
                <div class="card-event">
                  <img
                    src="https://miro.medium.com/max/720/1*_0u4XzW7F-lKTMOv1ldkNg.jpeg"
                    class="card-img-top"
                    alt="..."
                  />
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      ...
                      conference with 2000+ amazing engineers (embarking on a
                      nomadic
                      {/* journey from all corners of the continent){damage} */}
                    </p>
